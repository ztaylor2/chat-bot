...
def intention_analysis(message):
    ...
    print(luis_key)
    try:
        res = requests.get('https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/c200592a-cb41-46de-8008-72f23c577591?subscription-key={}&q={}'.format(luis_key, message))
        print(res)
        print(res.json())
        return res.json()
